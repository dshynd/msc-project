...
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.Cgen;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.Code;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.Decl;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.DeclarationContainer;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.ExceptionBlock;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.Location;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.StructConstructor;
import uk.ac.stand.cs.insense.compiler.barrelfishCCgen.StructValue;
...
//			both can start with an identifier
			...
			if( ste == null ) {
				...
				lex.nextSymbol();
				if( lex.current().equals( Symbols.LSB_SYM ) ) {  // we have an array of Components
