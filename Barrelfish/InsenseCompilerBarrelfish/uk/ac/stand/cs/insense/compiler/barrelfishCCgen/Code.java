...
public abstract class Code extends SpaceTracker implements ICode {
	...
	public static final String IFDEF_ = "#ifdef ";
	public static final String ELSEDEF_ = "#else ";
	...
	public static final String COPY_ON_SEND = "COPY_ON_SEND";
	public static final String COPY_TO_RECEIVER_HEAP = "COPY_TO_RECEIVER_HEAP";
	public static final String HASH_INCLUDE_ = "#include ";
	public static final String LIBRARY_NAME = "insense"; 
